...
void oscEvent(OscMessage theOscMessage) {
 if (theOscMessage.checkAddrPattern("/wek/outputs")==true) {
     if(theOscMessage.checkTypetag("f")) { // looking for 1 control value
        ...
        if(f == 1){//hvis output er 1 skal den sætte frekvens til 0
          sine.freq(0);
        }
        if(f == 2){//hvis output er 2 skal den sætte frekvens til tone d
          sine.freq(1174.66);
        }
        if(f == 3){//hvis output er 3 skal den sætte frekvens til tone e
          sine.freq(1318.51);
        }
        if(f == 4){//hvis output er 4 skal den sætte frekvens til tone c
          sine.freq(1046.50);
        }
        if(f == 5){//hvis output er 5 skal den sætte frekvens til tone C
          sine.freq(523.25);
        }
        if(f == 6){//hvis output er 6 skal den sætte frekvens til tone g
          sine.freq(783.99);
        }
     } else {
